 ...
 * under the License.
 */
package odata.service.user.web;
...
import odata.service.user.service.UserEntityCollectionProcessor;
import odata.service.user.service.UserEntityProcessor;
import odata.service.user.service.UserPrimitiveProcessor;

public class UserOdataServlet extends HttpServlet {

  private static final long serialVersionUID = 1L;
  private static final Logger LOG = LoggerFactory.getLogger(UserOdataServlet.class);
  ...
  protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    try {
      ...
      if (storage == null) {
        ...
        storage = new Storage(JWTFactory.getJWT_USER((String)session.getAttribute(JWTFactory.session_name)));
